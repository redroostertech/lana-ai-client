      ...
      <div id="conflictDetectionSection" class="space-y-4">
        <div class="flex items-center justify-between">
          <label class="block text-sm font-medium text-gray-700">
            Parties Involved
            <span class="text-xs text-gray-500 font-normal ml-2">(Optional - for conflict detection)</span>
          </label>
          <button type="button" id="addPartyBtn" class="text-sm text-indigo-600 hover:text-indigo-800 font-medium flex items-center gap-1">
        ...
        <!-- Parties List -->
        <div id="partiesList" class="space-y-2">
          ${this.renderPartiesList()}
        </div>

        <!-- Add Party Form (initially hidden) -->
        <div id="addPartyForm" class="hidden border border-gray-200 rounded-lg p-4 bg-gray-50">
          <div class="space-y-3">
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 gap-3">
              <div>
                ...
                <input type="email" id="partyEmail" class="w-full px-3 py-2 text-sm border border-gray-300 rounded-lg focus:ring-2 focus:ring-indigo-500">
              </div>
              <div>
                <label class="block text-xs font-medium text-gray-700 mb-1">Phone</label>
                <input type="tel" id="partyPhone" class="w-full px-3 py-2 text-sm border border-gray-300 rounded-lg focus:ring-2 focus:ring-indigo-500">
              </div>
            </div>
            <div class="grid grid-cols-1 md:grid-cols-2 gap-3">
              <div>
                <label class="block text-xs font-medium text-gray-700 mb-1">Organization</label>
                <input type="text" id="partyOrganization" class="w-full px-3 py-2 text-sm border border-gray-300 rounded-lg focus:ring-2 focus:ring-indigo-500">
              </div>
              <div>
                <label class="block text-xs font-medium text-gray-700 mb-1">Role/Title</label>
                <input type="text" id="partyRole" class="w-full px-3 py-2 text-sm border border-gray-300 rounded-lg focus:ring-2 focus:ring-indigo-500">
              </div>
            </div>
            <div class="flex justify-end gap-2 pt-2">
              <button type="button" id="cancelPartyBtn" class="px-3 py-1.5 text-sm text-gray-700 bg-white border border-gray-300 hover:bg-gray-50 rounded-lg font-medium">
                Cancel
              </button>
              <button type="button" id="savePartyBtn" class="px-3 py-1.5 text-sm bg-indigo-600 hover:bg-indigo-700 text-white rounded-lg font-medium">
                Add & Check Conflicts
              </button>
            </div>
          </div>
        ...
        <div id="conflictWarning" class="hidden"></div>
      </div>
    `;
  }
