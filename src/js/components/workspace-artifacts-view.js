...
(function (global) {
    ...
    this.container.innerHTML =
      '<div class="space-y-4">' +
        '<div class="flex flex-col gap-3 md:flex-row md:items-center md:justify-between">' +
          '<div>' +
            '<h4 class="text-sm font-semibold text-gray-900">Generated work product</h4>' +
            '<p class="text-xs text-gray-500 mt-0.5">Review LANA-generated drafts before saving them as official workspace documents.</p>' +
          '</div>' +
  ...
  var api = {
    ...
    getArtifactTitle: getArtifactTitle,
    getArtifactPersistence: getArtifactPersistence,
    getArtifactPromotionAction: getArtifactPromotionAction,
    getArtifactDocument: getArtifactDocument
  };
