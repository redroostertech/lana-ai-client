  ...
  var PAGE_DESCRIPTORS = {
    ...
    'document-library.html': {
      ...
      scripts: [
        ...
        'js/companion-bridge-consent.js',
        ...
        'js/lex/chat/lex-chat.composer-slash.js',
        'js/lex/chat/lex-chat.composer.js',
        'js/lex/chat/lex-chat.thread.js',
        'js/lex/chat/lex-chat.threads.js',
        ...
        'js/lex/components/chat/lex-lana-panel.js',
        'js/lex/components/layout/lex-lana-dock.js'
      ],
      stylesheets: [
        'css/lex-chat.css',
        'css/document-library.css',
        'css/document-create-modal.css',
        'css/companion-bridge-consent.css'
      ]
    },

    'document-library-templates.html': {
      title: 'Template Library',
      activeNav: 'library-templates',
      scripts: [
        'js/time-utils.js',
        'js/app-catalog.js',
        'js/lex/components/foundation/lex-badge.js',
        ...
        'js/lex/components/form/lex-segmented.js',
        'js/lex/components/data/lex-pagination.js',
        'js/shared/document-studio-templates-mapper.js',
        'js/document-studio-api.js',
        'js/services/document-create-modal.js',
        'js/document-library-templates.js',
        'js/companion-bridge-consent.js',
        'js/lex/chat/lex-chat.format.js',
        'js/lex/chat/lex-chat.conversations-api.js',
        'js/lex/chat/lex-chat.source.js',
      ...
      stylesheets: [
        'css/lex-chat.css',
        'css/document-library.css',
        'css/document-library-templates.css',
        'css/document-create-modal.css',
        'css/companion-bridge-consent.css'
      ]
    },
    ...
    'file-editor.html': {
      ...
      scripts: [
        ...
        'js/lex/components/foundation/lex-drawer.js',
        'js/lex/components/foundation/lex-modal.js',
        'js/file-editor/writer-tools.js',
        'js/file-editor/collaboration-tools.js',
        'js/file-editor/sheet-engine.js',
        'js/services/document-review-api.service.js',
        'js/services/file-editor-collaboration-api.service.js',
        'js/services/file-editor-content-api.service.js',
        'js/file-editor.js',
        'js/companion-bridge-consent.js',
        'js/lex/chat/lex-chat.format.js',
        'js/lex/chat/lex-chat.conversations-api.js',
